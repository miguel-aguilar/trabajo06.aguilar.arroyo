...
#condicional doble
#si el comprador es cpompulsivo mostrarle que ha ganado 10 bolsas mas del producto
#si el comprador no es compulsivo decirle que siga intentado
if(comprador_excesivo==True):
    print("OFERTA: usted ha ganado 10 bolsas de " + producto + " mas")

else:
    print("no pudo ganar nada, pero siga intentando")
#fin_if
